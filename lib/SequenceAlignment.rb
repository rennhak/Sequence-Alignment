...
# SequenceAlignment class is a CLI interface for the sa library
class SequenceAlignment # {{{

  # SequenceAlignment Constructor
  #
  # @param [OpenStruct] options Object returned from the SequenceAlignment::parse_cmd_arguments function
...
if __FILE__ == $0 # {{{
  ...
  options               = SequenceAlignment.new.parse_cmd_arguments( ARGV )
  sequence_alignment    = SequenceAlignment.new( options )
