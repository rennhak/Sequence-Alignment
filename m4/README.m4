...
WHAT IS THE SA PROJECT ?

Sequence Alignment (SA) is a software, which implements the problem of aligning two given sequences.
e.g. with the Needleman-Wunsch algorithm or others.
